Only support my caffe branch: https://github.com/happynear/caffe-windows/tree/hog (speed of ms branch may be very slow sometimes, the reason is unclear). It contains a GPU bounding box regression layer,
